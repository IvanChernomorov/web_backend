...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
	...
	if (!empty($_COOKIE['save'])) {
		...
		$flogin = "<p>Ваш логин :</p>" + (string)$_COOKIE['login'] + "<p>Ваш пароль:</p>" + (string)$_COOKIE['password'] +"<p><a href = 'login.php'>Войти</a></p>";
	...
	if (!empty($_COOKIE[session_name()]) && !empty($_SESSION['login'])) {
		//TODO: показывать логин
		$flog = "<div><a href = 'login.php'>Выйти из аккаунта</a></div>";
	} else {
