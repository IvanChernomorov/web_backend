...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
	...
	if (!empty($_COOKIE[session_name()]) && !empty($_SESSION['login'])) {
		$flog = "<span>Ваш логигн: </span>" . $_SESSION['login'] . "<br><div><a href = 'login.php'>Выйти из аккаунта</a></div><div><a href = 'adminlog.php'>Войти как админ</a></div>";
	} else {
		$flog = "<div><a href = 'login.php'>Войти в аккаунт</a></div><div><a href = 'adminlog.php'>Войти как админ</a></div>";
	}
